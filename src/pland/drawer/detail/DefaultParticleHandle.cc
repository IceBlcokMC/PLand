...
class DefaultParticleHandle::Impl {
    ...
    DefaultParticleHandle&                        mOwner;

public:
    explicit Impl(DefaultParticleHandle& owner) : mOwner(owner) {
...
DefaultParticleHandle::DefaultParticleHandle() : impl(std::make_unique<Impl>(*this)) {}
