...
- 增加无主领地的功能 @yangyangzhong82
- 新增冰霜行者冻结冰权限 `allowFrostWalker`。[#250](https://github.com/IceBlcokMC/PLand/issues/250) @yangyangzhong82
...
- **修复拦截器及权限加载异常**：解决因反射损坏导致插件启动时无法识别物品与方块权限规则、引发领地保护失效的问题。 @engsr6982
